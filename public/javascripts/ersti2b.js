...
function init() {
    ...
    var id=0;
    var id_speicher = [];
    var testarray = ["Seminar", "Übung", "Vorlesung", "Tutorium", "Kolloqium", "Workshop", "Konzert", "Festival", "Konferenz", "Sportereignis", "Party", "Oper", "Fest", "Tanzkurs", "Demonstration","Theaterstück"];
    var i = 0;
