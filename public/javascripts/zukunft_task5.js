    ...
    var CrosswordWidth = 15;
    var CrosswordHeight = 15;
    var Words = 10;
    var WordLength = new Array(14, 7, 13, 7, 6, 5, 15, 13, 10, 6);
    ...
    var AnswerHash = new Array(39001, 6949, 81454, 75543, 70681, 71564, 84033, 11313, 16271, 29075);
    var WordX = new Array(0, 0, 0, 0, 9, 5, 5, 11, 14, 8);
    var WordY = new Array(1, 4, 6, 10, 12, 14, 0, 1, 3, 5);
    var LastHorizontalWord = 5;
    var OnlyCheckOnce = false;


    // EclipseCrossword (C) Copyrigh t 2000-2013 Green Eclipse.
