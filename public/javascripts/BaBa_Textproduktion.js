...
function init() {
    ...
    function myFunction() {
        ...
        //Message
        if (count === 9) alert("Super! Du hast alles richtig gemacht! Auf zur nächsten Aufgabe!");
        else if (count > 4 && count < 9) alert("Sehr gut! Du hast die meisten Wörter richtig eingesetzt. Schau dir die Hinweise an.  Weiter so!");
