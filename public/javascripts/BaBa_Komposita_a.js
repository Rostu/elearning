...
function init() {
    ...
    function myFunction() {
        ...
        //Message
        if (count === 6) alert("Super! Du hast alles richtig gemacht! Auf zur nächsten Aufgabe!");
        else if (count > 3 && count < 6) alert("Sehr gut! Du hast die meisten Wörter richtig zusammengesetzt. Weiter so!");
