...
CrosswordHeight = 15;
Words = 10;
WordLength = new Array(14, 7, 13, 7, 6, 5, 15, 13, 10, 6);
Word = new Array("WELTWIRTSCHAFT", "ROBOTER", "HANDYSTRAHLEN", "ZUKUNFT", "LENKEN", "RADAR", "WISSENSCHAFTLER", "ATEMBERAUBEND", "VERDOPPELN", "TAPETE");
Clue = new Array("umfasst alle internationalen Wirtschaftsbeziehungen",
...
AnswerHash = new Array(39001, 6949, 81454, 75543, 70681, 71564, 84033, 11313, 16271, 29075);
WordX = new Array(0, 0, 0, 0, 9, 5, 5, 11, 14, 8);
WordY = new Array(1, 4, 6, 10, 12, 14, 0, 1, 3, 5);
