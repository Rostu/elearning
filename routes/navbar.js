var sites = [
    ['glueck_start','glueck_Textproduktion_Antonyme_A','glueck_Textproduktion_Antonyme_B','glueck_Textverstehen_Zeitangaben','glueck_Zeitstrahl','glueck_Textverstehen_Wortspirale','glueck_Textverstehen_Redensarten','glueck_Kreuzwortraetsel','glueck_Memory'],
    ['handy_start','handy_task1','handy_task2'],
    ['ersti_start','ersti_Textverstehen_emotionale_Woerter','ersti_Textverstehen_Wortfeld_Universitaet_A','ersti_Textverstehen_Wortfeld_Universitaet_B','ersti_Textverstehen_Wortfeld_Universitaet_C','ersti_Wortschatz_erweitern'],
